    ...
    for (let i = 0; i < files.length; i++) {
      ...
      try {
        if (file.size > 3 * 1024 * 1024) {
          throw new Error(`File "${file.name}" exceeds the maximum allowed size of 3MB.`);
        }
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }} className="entrance-fade">
        ...
        {!hasBaseCV ? (
          ...
          <div className="glass-card" style={{ padding: '2.5rem 2rem', maxWidth: '680px', margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
            {/* Dynamic Dropzone */}
            <div 
            ...
            >
              <Upload size={42} style={{ margin: '0 auto 0.75rem', color: 'var(--accent-primary)' }} />
              <h4 style={{ margin: '0 0 0.35rem 0', fontSize: '1.25rem', fontWeight: 800, color: 'var(--text-primary)' }}>
                {parsingFile 
                  ? 'Extracting text...' 
                  : 'Upload Your Master Base CV'}
              </h4>
              <p style={{ margin: 0, fontSize: '0.88rem', color: 'var(--text-muted)' }}>
                Drag &amp; Drop or Click to browse (Supports PDF, DOCX, TXT, and Markdown up to 3MB)
              </p>
            </div>
            ...
            <div className="glass-card" style={{ padding: '1.75rem 2rem', background: 'var(--card-bg)', border: '1.5px solid rgba(16, 185, 129, 0.4)', borderRadius: '18px', boxShadow: '0 0 24px rgba(16, 185, 129, 0.08)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.25rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                  ...
                  >
                    <Upload size={16} />
                    <span>{parsingFile ? 'Replacing...' : 'Replace Base CV'}</span>
                  </button>
